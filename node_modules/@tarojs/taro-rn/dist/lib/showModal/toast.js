...
function showToast(options) {
    ...
    if (image) {
        ...
        ToastView = React.createElement(View, { style: maskStyle },
            React.createElement(View, { style: styles.grayBlock },
                React.createElement(View, { style: styles.toastView },
                    React.createElement(Image, { source: icon === 'error' ? errorPng : successPng, style: styles.toastIcon }),
                    React.createElement(Text, { style: styles.toastContent }, title || ''))));
    }
    try {
...
function showLoading(options = { title: '加载中' }) {
    const isObject = shouldBeObject(options);
    if (!isObject.res) {
...
export { hideLoading, hideToast, showLoading, showToast };
