...
class DateSelector extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(AntDatePicker, { mode: mode, value: formatTimeStr(value), minDate: formatTimeStr(start), maxDate: formatTimeStr(end), onChange: this.onChange, onDismiss: this.onDismiss, disabled: disabled }, children));
    }
}
