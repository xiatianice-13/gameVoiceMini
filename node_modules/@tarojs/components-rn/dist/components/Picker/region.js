...
export default class RegionSelector extends React.Component {
    ...
    render() {
        ...
        return (
        // @ts-ignore
        React.createElement(AntPicker, { data: this.regionData, value: value, onChange: this.onChange, onOk: this.onOk, onVisibleChange: this.onVisibleChange, disabled: disabled }, children));
    }
}
