...
class Selector extends React.Component {
    ...
    render() {
        ...
        return (
        // @ts-ignore
        React.createElement(AntPicker, { data: range, value: [selected && selected.value], cols: 1, itemStyle: itemStyle, indicatorStyle: indicatorStyle, onChange: this.onChange, onPickerChange: this.onPickerChange, onOk: this.onOk, onVisibleChange: this.onVisibleChange, disabled: disabled }, children));
    }
}
