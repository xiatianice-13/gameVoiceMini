...
class TimeSelector extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(AntDatePicker, { mode: 'time', value: formatTimeStr(value), minDate: formatTimeStr(start), maxDate: formatTimeStr(end), onChange: this.onChange, onDismiss: this.onDismiss, disabled: disabled }, children));
    }
}
