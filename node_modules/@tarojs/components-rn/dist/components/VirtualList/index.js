...
class _VirtualList extends React.Component {
    ...
    render() {
        const _a = this.props, { itemData, itemSize, item, layout, overscanCount, children } = _a, restProps = __rest(_a, ["itemData", "itemSize", "item", "layout", "overscanCount", "children"]);
        ...
        const itemRow = ({ item: _item, index, separators }) => React.createElement(itemCom, {
            data: itemData,
            key: index,
            index,
            item: _item,
        ...
        return (React.createElement(FlatList, Object.assign({ scrollEventThrottle: 50 }, restProps, { data: itemData, windowSize: overscanCount, horizontal: layout === 'horizontal', ref: this.$ref, onScroll: this._onScroll, onScrollBeginDrag: this._onScrollBeginDrag, renderItem: itemRow, keyExtractor: (_item, index) => index + '' })));
    }
}
